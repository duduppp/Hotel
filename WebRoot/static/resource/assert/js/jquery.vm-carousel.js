...
(function ($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		init_controls: function()
		{
			...
			// Controls
			this.$btn_left = this.$container.append('<div   class="vmc-arrow-left"> </div>').find('.vmc-arrow-left');
			this.$btn_right = this.$container.append('<div   class="vmc-arrow-right"></div>').find('.vmc-arrow-right');
