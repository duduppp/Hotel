    ...
    */
    function courseManagerSupport(COURSEMANAGER_ID,SupportId){
 	...
 	function appendData(status){
 		var url="<%=basePath %>showLecturerCourse?SHOWSTATUS=9"; 
 		var lectureName='<%=request.getParameter("LECTURERNAME")%>'; 
		if(lectureName.length>0){ 
		  url="<%=basePath %>showLecturerCourse?LECTURERNAME="+lectureName; 
 		}
