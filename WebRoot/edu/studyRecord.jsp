    ...
    */
    function courseManagerSupport(COURSEMANAGER_ID,SupportId){
 	...
 	function appendData(status){
 		var url="<%=basePath %>studyRecord?READSTATUS="+status; 		
...
<body style="overflow: hidden; ">
    <div id="title1" >
		...
		&lt; </span></a>
		<span id="ftitle" style="text-align: center;width: 40%;margin-top: 5px;" >
			<button type="button" id="btn1" class="btn btn-success" onclick="openStudyRecord('0');" style="height: 98%;font: bold;">正在学习</button>
		</span>
		<span id="ftitle" style="text-align: center;width: 40%;margin-top: 5px;" >
			<button type="button" id="btn2" class="btn btn-warning" onclick="openStudyRecord('1');" style="height: 98%;font: bold;">已经完成</button>
		</span>
	</div> 
