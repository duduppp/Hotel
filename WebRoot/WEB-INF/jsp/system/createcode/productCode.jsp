...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<input type="hidden" name="fwStatus" id="fwStatus" value="0">
						<div id="zhongxin">
						...
						<table style="margin-top: 5px;">
							...
							<table style="margin-top: 5px;">
							<tr>
								<td style="width:79px;text-align: right;">是否工作流：</td>
								<td>
								        <div class="col-sm-9">
								            <label>
								                <input name="workflow" id="workflow" class="ace ace-switch ace-switch-5" type="checkbox" value="0" onclick="changeStata(this);" >	<span class="lbl"></span>
...
<!-- /.main-container -->	
		...
		$(document).ready(function(){
		   ...
		   var WORKFLOWSTATUS="${pd.WORKFLOWSTATUS}";
		   if(WORKFLOWSTATUS=="1"){
			   $("#fwStatus").val(1);    
				$("#workflow").attr("checked","checked");  
			}else{
