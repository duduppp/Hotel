						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	 ...
								 	 <select id="roleselect_id"  multiple="multiple">
									...
									<c:forEach items="${userList}" var="user" varStatus="vs">
										<tr>
											<td class='center' style="width: 30px;">
												<label><input type='radio' name="fhadmin" value1="${user.USERNAME }" value2="${user.NAME }" onclick="setUser(this)" class="ace"/><span class="lbl"></span></label>
											</td>
...
function setUser(obj){
	$("#USERNAME").val($(obj).attr("value1"));
	$("#NAME").val($(obj).attr("value2"));
}
