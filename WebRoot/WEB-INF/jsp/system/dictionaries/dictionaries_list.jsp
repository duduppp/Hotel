						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center"><i class="icon-time bigger-110 hidden-480"></i>创建时间</th>
									<th class="center"><i class="icon-time bigger-110 hidden-480"></i>修改时间</th>
