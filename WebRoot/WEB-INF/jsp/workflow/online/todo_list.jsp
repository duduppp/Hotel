										  ...
										  <fmt:formatDate value="${var.createTime}" pattern="yyyy-MM-dd HH:mm:ss" />
											...
											<td class="center">
												...
												<a class="btn btn-xs btn-white btn-warning btn-bold" onclick="currentNode('${var.processDefinitionId}','${var.processInstanceId}');">
														<i class="ace-icon icon-search bigger-120 orange"></i>
														办理任务
													</a>
													<a class="btn btn-xs btn-white btn-success btn-bold" onclick="currentNode('${var.processDefinitionId}','${var.processInstanceId}');">
														<i class="ace-icon icon-search bigger-120 green"></i>
														查看流程图
													</a>
