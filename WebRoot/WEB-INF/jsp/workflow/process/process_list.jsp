								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
										 ...
										 <td class='center'>
										 	<a href="javascritp:void(0);" onclick="currentType('xml','${var.id}');return false" >${var.resourceName}</a>
										 </td>
										 <td class='center'> 
										 	<a href="javascritp:void(0);" onclick="currentType('image','${var.id}');return false" >${var.resourceName}</a>
										 </td>
										 <td class='center'> 
										 	 <fmt:formatDate value="${var.deploymentTime}" pattern="yyyy-MM-dd HH:mm:ss" />
										 </td>
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<c:if test="${QX.del == 1 }">
														<a class="btn btn-xs btn-danger" onclick="del('${var.id}');">
															<i class="ace-icon fa fa-trash-o bigger-120" title="删除流程"></i>
														</a> 
													</c:if>
													<c:if test="${QX.edit == 1 }">
														<a class="btn btn-xs btn-success" title="转换模型 " onclick="convertToModel('${var.id}');">
															<i class="icon-retweet color-bright-blue bigger-140" title="转换模型"></i>
														</a>  
													</c:if>
												</div> 
