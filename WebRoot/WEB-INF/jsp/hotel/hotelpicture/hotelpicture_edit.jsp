			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
					    ...
					    <form action="hotelpicture/${msg }.do" name="Form" id="Form" method="post">
					
						<input type="hidden" name="HOTELPICTURE_ID" id="HOTELPICTURE_ID" value="${pd.HOTELPICTURE_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">名称:</td>
								<td><input type="text" name="PICNAME" id="PICNAME" value="${pd.PICNAME}" maxlength="255" placeholder="这里输入名称" title="名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;" id="FILEPATHn">图片:</td>
								<td>
								<input type="hidden" name="LOGINNAME" id="LOGINNAME" value="${pd.LOGINNAME}" maxlength="255" placeholder="这里输入名称" style="width:98%;"/>
									<input type="file" name="File_name" id="uploadify1" keepDefaultStyle = "true"/>
									<input type="text" name="PICPATH" id="PICPATH" value="${pd.PICPATH}"/>
								</td>
							</tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$(document).ready(function(){
			...
			$("#PICNAME").val("图片"+Math.floor(Math.random() * 9999 + 1) );
