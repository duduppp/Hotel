			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="backgroundimg/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="BACKGROUNDIMG_ID" id="BACKGROUNDIMG_ID" value="${pd.BACKGROUNDIMG_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:105px;text-align: right;padding-top: 13px;">背景图片名称:</td>
								<td>
									<input type="text" name="IMGNAME" id="IMGNAME" value="${pd.IMGNAME}" maxlength="255" placeholder="这里输入背景图片名称" title="背景图片名称" style="width:98%;"/>
							...
							<tr>
								<td style="width:105px;text-align: right;padding-top: 13px;">图片路径:</td>
								<td>  
									<input type="file" name="File_name" id="uploadify1" keepDefaultStyle="true"/>
									<input type="text" name="IMGPATH" id="IMGPATH" value="${pd.IMGPATH}"/>  
								</td> 
							</tr>
							<tr>
								<td style="width:105px;text-align: right;padding-top: 13px;">备注:</td>
								<td><input type="text" name="REMARK" id="REMARK" value="${pd.REMARK}" maxlength="255" placeholder="这里输入路径" title="路径" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$(function() {
			...
			if(imgname.length==0){
				$("#IMGNAME").val("背景图"+Math.floor(Math.random()*10000)+1);
			}
