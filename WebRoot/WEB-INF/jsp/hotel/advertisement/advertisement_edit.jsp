				...
				<div class="row">
					...
					<form action="advertisement/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">广告图片:</td>
								<td>
								
									<input type="file" name="File_name" id="uploadify1" keepDefaultStyle = "true"/>
									<input type="text" name="ADVIMG" id="ADVIMG" value="${pd.ADVIMG}"/>
								<input type="hidden" name="LOGINNAME" id="LOGINNAME" value="${pd.LOGINNAME}" maxlength="255" placeholder="这里输入账号名称" title="账号名称" style="width:98%;"/>
								</td>
							</tr>
							<tr>
