		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="vedios/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="VEDIOS_ID" id="VEDIOS_ID" value="${pd.VEDIOS_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
							 ...
							 <tr>
								<td style="width:75px;text-align: right;padding-top: 13px;" id="FILEPATHn">视频:</td>
								<td>
									<input type="file" name="File_name" id="uploadify1" keepDefaultStyle = "true"/>
									<input type="text" name="FILEPATH" id="FILEPATH" value="${pd.FILEPATH}"/>
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$(function() {
			...
			$("#uploadify1").uploadify({ 
				...
				'folder'	:	"<%=basePath%>uploadFiles/hotel/videos/",//上传文件存放的路径,请保持与uploadFile.jsp中PATH的值相同
				'queueId'	:	"fileQueue",  
				...
				'buttonText':	"files",
				'scriptData':	{'uploadPath':'/uploadFiles/hotel/videos/'},//这个参数用于传递用户自己的参数，此时'method' 必须设置为GET, 后台可以用request.getParameter('name')获取名字的值
				'method'	:	"GET",
				...
				'onAllComplete' : function(event,data) {
					//全部上传完毕执行
					$("#FILEPATH").val("/uploadFiles/hotel/videos/"+str);
					$("#Form").submit();
					$("#zhongxin").hide();
					$("#zhongxin2").show();
		    	},
