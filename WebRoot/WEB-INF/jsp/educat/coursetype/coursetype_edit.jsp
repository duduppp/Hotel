			...
			<div class="page-content">
				<div class="row">
					...
					<form action="coursetype/${msg }.do" name="Form" id="Form" method="post">
						...
						<input type="hidden" name="PARENT_ID" id="PARENT_ID" value="${null == pd.PARENT_ID ? COURSETYPE_ID:pd.PARENT_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="COURSE_NAME" id="COURSE_NAME" value="${pd.COURSE_NAME}" maxlength="255" placeholder="这里输入课程类别" title="课程类别" style="width:98%;"/></td>
							</tr>
							<tr>
