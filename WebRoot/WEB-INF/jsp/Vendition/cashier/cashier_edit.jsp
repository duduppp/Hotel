		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="cashier/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="CASHIER_ID" id="CASHIER_ID" value="${pd.CASHIER_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">用户权限:</td>
								<td><input type="text" name="JURISDICTION" id="JURISDICTION" value="${pd.JURISDICTION}" maxlength="255" placeholder="这里输入用户权限" title="用户权限" style="width:98%;"/></td>
							</tr>
							<tr>
