				...
				<div class="row">
					...
					<form action="vipuser/${msg}.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" style="width: 100%;">
							<tr>
								<td style="text-align:center;padding-top: 13px;font-size: 26px;width: 50%;">初始存值:</td>
								<td  style="text-align:center;padding-top: 13px;font-size: 26px;">赠送金额</td>
							...
							<tr>
								<td style="text-align: center;"> 
									<input type="number" name="STORAGEBALANCE" id="STORAGEBALANCE" value="0" maxlength="255" placeholder="这里输入存储余额" title="存储余额" style="width:58%;"/>
							    </td>
								<td style="text-align: center;">
								    <input type="number" name="DonationAmount" id="DonationAmount" value="0" maxlength="255" placeholder="这里输入存储余额" title="存储余额" style="width:58%;"/>
								</td>
							</tr>
							...
							<tr style="height: 50px;">
						 	...
						 	<tr>
						 		<td style="font-size: 14px;text-align: left;">当前会员号：${pd.CARDNO }</td>
						 		<td  style="font-size: 14px;text-align: left;">
						 		   余额：¥${pd.STORAGEBALANCE }
						 		</td>
							</tr>
							
							<tr >
								<td colspan="4" style="text-align: right;" colspan="2">
