		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="shopbasicinfo/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="SHOPBASICINFO_ID" id="SHOPBASICINFO_ID" value="${pd.SHOPBASICINFO_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="SHOPNAME" id="SHOPNAME" value="${pd.SHOPNAME}" maxlength="255" placeholder="这里输入店铺名称" title="店铺名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">联系电话:</td>
								<td><input type="text" name="TEL" id="TEL" value="${pd.TEL}" maxlength="255" placeholder="这里输入联系电话" title="联系电话" style="width:98%;"/></td>
							</tr>
							<tr>
