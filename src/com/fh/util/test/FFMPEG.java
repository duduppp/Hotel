...
//         String ffmpeg_path,String input_path,String video_converted_path,String logo,String screen_size,String xaxis,String yaxis,String vb,String ab  
       ...
       public static void  main(String [] arg){  
           ...
           dto.put("ffmpeg_path", "g:\\ffmpeg.exe");//必填  
           dto.put("input_path", "F:/server/apache-tomcat-7.0.56/webapps/Hotel/uploadFiles/edu/2017101211593130540.rmvb");//必填  
           dto.put("video_converted_path", "F:/server/apache-tomcat-7.0.56/webapps/Hotel/uploadFiles/edu/chenglong001.mp4");//必填  
           dto.put("logo", "g\\\\:/logo.png");//可选(注意windows下面的logo地址前面要写4个反斜杠,如果用浏览器里面调用servlet并传参只用两个,如 d:\\:/ffmpeg/input/logo.png)  
