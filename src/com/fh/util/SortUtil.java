...
public class SortUtil {
	 ...
	 *            排序类型：正序-asc；倒序-desc
	 */
	public static List<Object> sort(List<Object> sortList, String param1,
			String orderType) {
	 ...
	 *            排序类型：正序-asc；倒序-desc
	 */
	public static List<Object> sortParam2(List<Object> sortList, String param1,
			String param2, String orderType) {
		Comparator<Object> mycmp1 = ComparableComparator.getInstance();
