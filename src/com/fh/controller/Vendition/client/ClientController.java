package com.fh.controller.Vendition.client;
...
public class ClientController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("Vendition/client/client_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("Vendition/client/client_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("CLIENTID"));	    //1
			vpd.put("var2", varOList.get(i).getString("CLIENTNAME"));	    //2
