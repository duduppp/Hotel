package com.fh.controller.Vendition.stock;
...
import com.fh.service.Vendition.stock.StockManager;
...
public class StockController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("Vendition/stock/stock_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("Vendition/stock/stock_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("STOCKID"));	    //1
			vpd.put("var2", varOList.get(i).getString("WAREID"));	    //2
			vpd.put("var3", varOList.get(i).getString("STOCKDATE"));	    //3
			vpd.put("var4", varOList.get(i).getString("STOCKAMOUNT"));	    //4
