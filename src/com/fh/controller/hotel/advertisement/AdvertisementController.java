package com.fh.controller.hotel.advertisement;
...
public class AdvertisementController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("ADVERTISEMENT_ID", this.get32UUID());	//主键
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("hotel/advertisement/advertisement_list");
	...
	public String listData() throws Exception{
		...
		List<PageData>	varList = advertisementService.listAll(pd);	//列出BackgroundImg列表
		String json = "";
		if (null != varList) {
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("hotel/advertisement/advertisement_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("ADVIMG"));	    //1
			vpd.put("var2", varOList.get(i).getString("LOGINNAME"));	    //2
			varList.add(vpd);
		}
